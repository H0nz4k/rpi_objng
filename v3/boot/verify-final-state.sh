...
if grep -q # Final state verification for ObjednavkaNG MASTER BOOT FINAL v2.1.7.
set -u
...
check "TeamViewer prikaz" command -v teamviewer
check "TeamViewer sluzba aktivni" systemctl is-active --quiet teamviewerd.service
...
" "$@"; fi
# Final state verification for ObjednavkaNG MASTER BOOT FINAL v2.1.7.
set -u
